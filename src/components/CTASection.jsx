          ...
          <div className="relative z-10 grid lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <h2 className="text-4xl lg:text-6xl font-bold leading-tight">
                Upgrade Your Blood Analysis Laboratory
              </h2>
              <p className="mt-6 text-white/80 text-lg leading-8 max-w-xl">
                Partner with Raj Biosis for certified haemoglobin meters and automated diagnostic devices engineered for clinical precision.
              </p>
            </div>
            <div className="flex lg:justify-end">
              <div className="bg-white text-slate-900 rounded-[32px] p-8 max-w-md w-full shadow-2xl">
                ...
                <p className="mt-3 text-slate-600 leading-7">
                  Connect with our clinical diagnostics experts to discuss your lab equipment requirements and pricing options.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 mt-8">
                  ...
                  <a href="tel:+919876543210" className="border border-slate-300 px-6 py-4 rounded-2xl font-semibold hover:bg-slate-100 transition text-center">
                    Call Now
                  </a>
                </div>
              </div>
