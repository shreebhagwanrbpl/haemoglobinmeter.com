...
export async function fetchHomeData() {
  return fetchDocCached("websites/haemoglobinmetercom/pages/home");
}

export async function fetchContactData() {
  return fetchDocCached("websites/haemoglobinmetercom/pages/contact");
}

export async function fetchServicesData() {
  return fetchDocCached("websites/haemoglobinmetercom/pages/services");
}

export async function fetchDistrictData(district) {
  if (!district) return null;
  return fetchDocCached(`websites/haemoglobinmetercom/districts/${district}`);
}
